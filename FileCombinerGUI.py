...
def combine_files():
    # Determine newline inserts + number of input files
...
input_browse_button = tk.Button(root, text="Browse",
...
output_browse_button = tk.Button(root, text="Browse",
                                 command=lambda: browse_file(output_entry))
